...
public class OrderGUI extends QWidget{
	...
	private void insertOrder() {
		...
		String time = new java.sql.Timestamp(
				new java.util.Date().getTime()).toString();
		
		Timestamp currentTime = new java.sql.Timestamp(
	...
	public void displayCustomer(int customerID) {
		try {
			...
			String[] fields = {"Fornavn: ","Etternavn: ","Adresse: ","Poststed: ",
					"Postkode: ", "Telefon: "};
	...
	private void setTime(){
		...
		/*will have to add one day if must the clock is between
		 * 23:00 and 24:00
		 */
		if (time.hour()<1) {
	...
	private void setUpGUI(){
		...
		/*sets the size policies for the lists and 
		 * textbrowser and the size for the groupbox
		 */
