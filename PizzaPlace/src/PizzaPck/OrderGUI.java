...
public class OrderGUI extends QWidget{
	...
	private void handleListProducts(String[] data) {
		...
		System.out.println("St√∏rrelsen p√• mirror list"+listProductsMirror.size()+"");
	}
	...
	private void removeFromLists() {
		...
		System.out.println("St√∏rrelse p√• listen"+listProductsMirror.size()+"");
	}
	...
	private void confirmOrders() {
		//TODO: mÂ fikse hva som skal komme ut nÂr man ikke har lagt til produkter og trykker pÂ bekreft
